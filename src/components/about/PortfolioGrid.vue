        ...
        <div class="container">
            <div class="grid">
                ...
                <div class="card div3">
                    ...
                    <div class="tech-stack-grid-container">
                        <TechstackGrid />
                    </div>
                </div>
                <div class="card div5">
...
.div2 .time-zone-globe-img {
    position: absolute;
    bottom: 0;
    z-index: 1;
}

.div2 .shiny-glass-img {
    position: absolute;
    bottom: 0;
    z-index: 0;
}
...
.div3 {
    ...
    background: linear-gradient(45deg, #04071D, #0C0E23);
}
...
.div3 .tech-stack-grid-container {
    position: absolute;
    z-index: 1;
    right: 0;
    top: -10px;
